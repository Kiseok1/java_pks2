...
public class J0914_10 {
	...
	public static void main(String[] args) {
		...
		m[3] = new Member ("ddd","4444","강감찬","인천","010-4444-4444");
		m[4] = new Member ("eee","5555","김 구","광주","010-5555-5555");
		...
		for (int i=0;i<list.size();i++) {
			...
			System.out.printf("[%s, %s, %s, %s, %s]\n",temp.getId(),temp.getPw(),temp.getName(),temp.getAddress(),temp.getPhone());
		}
