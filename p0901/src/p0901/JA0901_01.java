...
//		math = 100;
		...
		int number2 = 0; // 정수형 타입을 생성해서 0읠 값을 입력
		String name2 = ""; // 문자열 타입을 생성해서 빈공백을 입력
		int kor2 = 0; // 국어점수를 입력할 수 있는 변수 선언
		int eng2 = 0;
		int math2 = 0;
		int total2 = 0; // 합계점수를 입력할 수 있는 변수 선언
		double avg2 = 0; // 실수형타입을 생성해서 0의 값을 입력
